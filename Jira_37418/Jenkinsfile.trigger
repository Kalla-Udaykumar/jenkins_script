...
def buildJob( BRANCH_NAME, PLATFORM ){
	...
	println ("platform" + "${PLATFORM}")
		...
		string(name: 'OS_Artifacts', value:"${os_artifacts}"),
...
def getConfig(PLATFORM) {
        ...
        env.os_artifacts = "${props.daily.branch."${env.BRANCH_NAME}"."${PLATFORM}".os_artifacts_folder_link}"
